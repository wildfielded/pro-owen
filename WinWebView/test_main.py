...
from PyQt5.QtCore import QCoreApplication, QRunnable, QThreadPool, QUrl, pyqtSlot
...
class OwenWindow(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setup_main_win()
        self.threadpool_ = QThreadPool()
        self.html_ = BgCreator()
        self.threadpool_.start(self.html_)
