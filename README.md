...
или дополнительные поля внутри страницы с кнопками квитирования, плюс
проигрываться страшные звуки тревоги.    
...
на версии python-3.8.10, там меньше возможностей настройки, как в версии 3.10,
